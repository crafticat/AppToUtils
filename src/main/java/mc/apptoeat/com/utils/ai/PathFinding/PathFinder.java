...
public class PathFinder {
    ...
    public static Vector newMotion(DataLocation from, Vector lastMotion, double speed, World world, Integer UUID, boolean ground,Vector velocity,float dirOffSet) {
    ...
    public static DataLocation minecraftMove(World world,Location currentLocation,Integer UUID,boolean onGround,Vector velocity,boolean takeGivenVelocity) {
        ...
        Vector motion = PathFinder.newMotion(location.clone(),lastMot,0.1,world,UUID,true,velocity.clone(),0);
